...
const Coding = () => {
  return (
    <div>
      <div className="heading flex justify-start items-center gap-3 py-8 px-3">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="800px"
          height="800px"
          viewBox="0 0 24 24"
          className="w-12 h-12 text-blue-400 group-hover:scale-110 transition-transform duration-500"
          fill="none"
        >
          <path
            opacity="0.5"
      ...
      <div className="maincode pt-4 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 w-fit m-auto gap-x-5 gap-y-5">
        <div className="code w-[300px] md:w-[350px] lg:w-[400px] h-[100px] md:h-[120px] lg:h-[130px] mx-auto bg-amber-950 flex justify-between overflow-hidden rounded-2xl my-4">
          <img
            ...
            alt=""
          />
          <div className="codename w-[70%] h-[100%] text-center pt-3 md:pt-4 lg:pt-5">
            <p className="text-white text-md md:text-lg lg:text-xl font-semibold pb-2">
              sahilkhan001
            </p>
            <p className="text-xs md:text-sm lg:text-lg">250+ problems solved</p>
            <button className="px-2 md:px-3 py-1 bg-amber-500 text-sm text-black font-semibold rounded-2xl">
              <a href="https://leetcode.com/u/sahilkhan001/">Visit Profile</a>
            </button>
          </div>
        </div>
        <div className="code w-[300px] md:w-[350px] lg:w-[400px] h-[100px] md:h-[120px] lg:h-[130px] mx-auto bg-green-950 flex justify-between overflow-hidden rounded-2xl my-4">
          ...
          <div className="codename w-[70%] h-[100%] text-center pt-3 md:pt-4 lg:pt-5">
            ...
            <p className="text-xs md:text-sm lg:text-lg">300+ problems solved</p>
            <button className="px-3 py-1 bg-green-500 text-sm text-black font-semibold rounded-2xl">
              <a href="https://www.geeksforgeeks.org/profile/sksahilk0jse">
                Visit Profile
              </a>
            </button>
          </div>
        ...
        <div className="code w-[300px] md:w-[350px] lg:w-[400px] h-[100px] md:h-[120px] lg:h-[130px] mx-auto bg-blue-800 flex justify-between overflow-hidden rounded-2xl my-4">
          ...
          <div className="codename w-[70%] h-[100%] text-center pt-3 md:pt-4 lg:pt-5">
            ...
            <button className="px-3 py-1 bg-rose-700 text-sm text-black font-semibold rounded-2xl">
              <a href="https://codeforces.com/profile/sahilkhan001">
                Visit Profile
              </a>
            </button>
          </div>
